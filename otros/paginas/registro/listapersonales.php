        ...
        <div class="span6">
          ...
          <div class="widget-header">
            <h3>Lista de Empleados</h3>   
              <a href="formulariocom.php?id_per=<?php echo $rowTotal0["id_persona"]; ?>" class="active">
...
die($message);
			...
			while ($rowTotal = $resultados->fetch_assoc())
			{
				?>
                    ...
                    <td><a href="reportes.php?id_per=<?php echo $rowTotal["id_persona"]; ?>">ver</a></td>
                    <td><?php 
...
and diagnostico.id_persona=$persona";
					...
					?>Aplicar</a></td>
                     <td><a href="formulariocom2.php?id_per=<?php echo $rowTotal["id_persona"]; ?>">Actualizar</a></td>
